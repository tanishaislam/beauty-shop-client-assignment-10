    ...
    return (
        <div>
            ...
            <div className="text-center h-[80vh] flex justify-center items-center flex-col bg-white bg-opacity-60">
                ...
                <p className="text-lg mt-8 lg:w-1/3 md:w-1/2 w-auto m-auto text-zinc-700 font-semibold">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptatibus, ipsam corrupti officia facere omnis, natus beatae in neque porro, nihil maxime sunt. Dolores aut mollitia</p>
