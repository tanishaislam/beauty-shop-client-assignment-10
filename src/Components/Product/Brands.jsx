...
const Brands = () => {
    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="lg:grid-cols-3 md:grid-cols-2 grid-cols-1 grid gap-14 px-5">
           
            {
                users.map(user => <>
                <button onClick={()=> handleSub(user.brandName)}>
                <div className="card card-compact bg-base-100 shadow-xl">
                <figure><img src={user.image} alt="Shoes" className="h-64 w-full" /></figure>
